...
public class MailSendUtils {
	 ...
	 private final static String host = "smtp.sina.com"; //sina的服务器
	    private final static String formName = "15605179762@sina.cn";//你的邮箱
	    private final static String password = "15605179762+wang"; //授权码
	    private final static String replayAddress = "15605179762@sina.cn"; //你的邮箱
	    ...
	    private static Message getMessage(MailInfo info) throws Exception{
	        ...
	        //消息的发送者
	        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"王瑶"));
